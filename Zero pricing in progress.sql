Select 
	...
	db1.TARIFTYP as "RCAT - Installation", 
	db1.STATTART as "RType - Installation", 
	ettifn.kondigr as "IRFG RFG",
	easts.TARIFART as "Device rate type",
	easts.logikzw as "Device Number",
	db1.EIN01 as "EIN01", 
	db1.EIN02 as "EIN02", 
...
and ERCH.BEGABRPE BETWEEN EASTS.AB AND EASTS.BIS
