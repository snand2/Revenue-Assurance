Select 
                ...
                USGE.TOTAL_CONSUMPTION,
				USGE.TOTAL_BILL_DAYS,
				USGE.DAILY_KHW_RATE
...
FROM
SP_COMMERCIAL.CUSTOMER_KWH_USAGE_12MONTHS) USGE
on
C.UEC_CONTRACT = USGE.CONTRACT


Where C.UEC_MOVE_IN between '20210831' and current_date --this line is where you put your date range
