...
case 
	...
	when "New Sub-Trans desc group" like 'Mercantile Settlement- CR' then 'Covid 19 Relief Credit - Settle for less'
	when "New Sub-Trans desc group" like 'QLD Govt Utility Relief Rebate'then 'Covid 19 Relief Credit - QLD Govt Utility Relief'
	when "New Sub-Trans desc group" like 'ENA Network Relief' then 'ENA Network Relief'
	when "New Sub-Trans desc group" like 'ENA Re-Energise & De-Energise Relief' then 'ENA Re-Energise & De-Energise Relief'
	when "New Sub-Trans desc group" like 'Unbillable Consumption Manual' then 'Unbillable Consumption Manual'
else null 
...
or (hvorg in ('Z450') and tvorg in ('0060') and (XBLNR >'0'))
